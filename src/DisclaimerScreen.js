...
export class DisclaimerScreen extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            feeAccepted: Config.devFeePercentage <= 0,
                    ...
                    <View style={{flexDirection: 'row', marginRight: 20, marginLeft: 25, marginBottom: 20}}>
                        ...
                        <View style={{flex: 1}}>
                            <Text style={{
                                ...
                                I understand that I am the sole owner of my private keys/seed, and if I lose them, my
                    ...
                    <View style={{flexDirection: 'row', marginRight: 20, marginLeft: 25, marginBottom: 20}}>
                        ...
                        <View style={{flex: 1}}>
                            <Text style={{
                                ...
                                I understand that no warranty or guarantee is provided, expressed, or implied when using
                                this app and any funds lost in using this app are not the responsibility of the
