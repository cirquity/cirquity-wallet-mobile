...
class BalanceComponent extends React.Component {
    ...
    render() {
        const compactBalance = <OneLineText
                                     style={{ color: this.props.lockedBalance === 0 ? this.props.screenProps.theme.pinCodeForegroundColour : '#7c69ef', fontSize: 30}}
        ...
        const lockedBalance = <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                                    <FontAwesome name={'lock'} size={18} color={'#7c69ef'} style={{marginRight: 7}}/>
                                    <OneLineText style={{ color: '#7c69ef', fontSize: 20}}
                                          onPress={() => this.setState({
                                             expandedBalance: !this.state.expandedBalance
                                          })}>
        ...
        const unlockedBalance = <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                                    <FontAwesome name={'unlock'} size={20} color={this.props.screenProps.theme.pinCodeForegroundColour} style={{marginRight: 7}}/>
                                    <OneLineText style={{ color: this.props.screenProps.theme.pinCodeForegroundColour, fontSize: 25}}
                                          onPress={() => this.setState({
