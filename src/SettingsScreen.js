                ...
                <ScrollView style={{
                    ...
                    <Card title='Private Spend Key'>
                        <View style={{
                            ...
                            <Text style={{fontSize: 14, color: this.props.screenProps.theme.slightlyMoreVisibleColour}}>
                    ...
                    <Card title='Private Spend Key' containerStyle={{marginBottom: 20}}>
                        <View style={{
                            marginTop: 10,
                            marginRight: 30,
                            borderWidth: 1,
                ...
                <FlatList
                    ...
                    renderItem={({item}) => (
                        <ListItem
                            ...
                            leftIcon={
                                <View style={{width: 30, alignItems: 'center', justifyContent: 'center', marginRight: 10}}>
                                    <item.icon.IconType name={item.icon.iconName} size={25} color={this.props.screenProps.theme.iconColour}/>
                                </View>
                            }
                            rightIcon={item.checkbox &&
                                <View style={{width: 30, alignItems: 'center', justifyContent: 'center', marginRight: 10}}>
                                    <MaterialIcons name={item.checked ? 'check-box' : 'check-box-outline-blank'} size={25} color={this.props.screenProps.theme.secondaryColour}/>
                                </View>
                            }
